...
@Component({
  selector: 'ProductPromotion-home',
  templateUrl: './ProductPromotion-home.component.html',
  styleUrls: ['./ProductPromotion-home.component.scss']
})
export class ProductPromotionHomeComponent implements AfterViewInit {
